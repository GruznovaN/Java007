...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Введите выражение [2+2] или два." +
                "" +
                " римских числа от I до X:[V+V] + Enter ");
        ...
        for (int i = 0; i < userInput.length(); i++) {
           ...
           {
               throw new ArrayIndexOutOfBoundsException("**Нарушено условие ввода, формат ввода a+b**");
           }
            if (under_char[i] == '+') {
                operation = '+';
                operation_char[i] = '+';
        ...
        String w=q.trim();
           ...
           if( w.length()>1)
           {throw new Exception ("**Введено больше одного оператора(+,-,/,*), формат ввода a+b**");
        }

            String under_charString = String.valueOf(under_char);
            String[] numbers = under_charString.split("[+-/*]");
            if (numbers.length<2)
            {throw new Exception ("**Не введен оператор(+,-,/,*) и  второй операнд, формат ввода a+b**");}
        ...
        if (number1 < 1 || number1 > 10 || number2 < 1 || number2 > 10) {
                                    result = 0;
            throw new Exception("Введены недопустимые числа, условие: числа должны быть от 1 до 10 включительно или не введен второй операнд");
        } else {
            ...
            try {
                ...
                throw new NumberFormatException("**Не введен второй операнд, формат ввода a+b**");
